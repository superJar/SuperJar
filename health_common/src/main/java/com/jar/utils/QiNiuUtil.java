...
public class QiNiuUtil {
    ...
    private static final String ACCESSKEY = "0SMO47rXgH1LIBTvESOAd9ymAUp-Qkh5vbrpm7tk";
    private static final String SECRETKEY = "lh9JX1AKB02a0daXx21JvBFFkO0WFUIeUkxcnZUx";
    private static final String BUCKET = "superjar";
    public static final String DOMAIN= "http://q2qkubjje.bkt.clouddn.com/";

    public static void main(String[] args) {
        uploadFile("D:\\IdeaProjects\\health_parent\\health_web\\src\\main\\webapp\\img\\user1-128x128.jpg","user1-128x128.jpg");
